# MOVIEMANIA - Free Movies & TV Shows Streaming
...
🍿MOVIEMANIA🍿 is an open-source, free movies and TV shows streaming platform built with the latest web technologies. It offers a seamless and enjoyable viewing experience, allowing users to discover, search, and enjoy a vast library of content.

## Key Features

- **💸 Free and Open-Source**: MOVIEMANIA is completely free to use and the source code is available for anyone to explore, contribute, and build upon.
...
- **The Movie Database (TMDB) API**: MOVIEMANIA integrates with the TMDB API to retrieve movie and TV show data, ensuring access to a vast and up-to-date content library.

## Getting Started

To run MOVIEMANIA locally, follow these steps:

1. Clone the repository:

```
git clone https://github.com/Nityanand17/moviemania.git
```
